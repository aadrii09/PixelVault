...
<template>
    <div class="bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-3xl p-6 transition-all duration-300 hover:transform hover:-translate-y-2 hover:shadow-lg hover:shadow-[#00ccff]/20 hover:border-[#00ccff] product-card">
        <!-- Product Image -->
        <div class="w-full h-[200px] bg-gradient-btn rounded-2xl mb-4 flex items-center justify-center overflow-hidden product-image">
            <img 
        ...
        <div class="flex space-x-2 mt-4">
            ...
            >
                ...
                <span class="absolute inset-0 bg-gradient-to-r from-[#00ff88] to-[#00ccff] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
            </button>

            <!-- View Details Button -->
            <button
                @click="$emit('view-details', props.producto)"
            ...
            >
                ...
                <span class="absolute inset-0 bg-gradient-to-r from-[#c084fc] to-[#8b5cf6] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
            </button>
        </div>
    </div>
</template>
