...
<template>
  <div v-if="route.path === '/'" class="navbar-bg min-h-screen w-full flex flex-col">
    ...
    <div class="flex flex-col items-center justify-center flex-grow">
      ...
      <a href="#explora" class="bg-white bg-opacity-20 text-white text-xl font-medium rounded-full px-10 py-2 hover:bg-opacity-30 transition-all duration-200">
        Explora
      </a>
    </div>
    
    <!-- Admin Panel centrado en la parte inferior -->
